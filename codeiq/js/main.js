...
retro.view.ConsoleView = function(snap) {
	...
	while(_g1 < _g11.length) {
		var t = _g11[_g1];
		++_g1;
		t.attr({ 'font-size' : "12pt", fill : "#696969", 'font-family' : "MyriadPro-Regular", width : 220});
	}
	this.graphic.attr({ fill : "#F4F4F4", stroke : "#696969", strokeWidth : 1});
	this.pos = new retro.pub.Point2D(0,0);
...
retro.view.DiagramView = function(diagramController) {
	...
	Snap.load("images/create.svg",function(f) {
		...
		g.attr({ fill : "#ffffff", stroke : "#696969", strokeWidth : 1});
	...
	Snap.load("images/dustbox.svg",function(f) {
		...
		g.attr({ fill : "#ffffff", stroke : "#696969", strokeWidth : 1});
		rect.attr({ strokeWidth : 1, stroke : "#696969", fill : "#F4F4F4"});
...
retro.view.InputPortView = function(diagramController,jobview,port,snap) {
	...
	text.attr({ 'font-size' : "12pt", fill : "#696969", 'font-family' : "MyriadPro-Regular"});
...
retro.view.InputPortView.prototype = $extend(retro.view.PortView.prototype,{
	...
	,OnSetConstant: function(v) {
		...
		text.attr({ 'font-size' : "12pt", fill : "#ffffff", 'font-family' : "MyriadPro-Regular"});
...
retro.view.JobView = function(diagramController,jobController,diagramView) {
	...
	if(Type.getClassName(Type.getClass(this.jobController.getJob())) == "retro.model.EntryJob") {
		...
		this.graphic.attr({ strokeWidth : 1, stroke : "#696969", fill : "#F4F4F4"});
	...
	line.attr({ strokeWidth : 1, stroke : "#696969"});
	this.pos = new retro.pub.Point2D(0,0);
	this.prev_pos = new retro.pub.Point2D(0,0);
	this.setPos(100,100);
	this.coll.attr({ fill : "#ffffff", 'fill-opacity' : 0});
...
retro.view.OutputPortView = function(diagramController,jobview,port,snap) {
	...
	this.graphic.attr({ fill : "#D3D3D3", stroke : "#696969", strokeWidth : 1});
	...
	this.port.onSelected = function() {
		_g.graphic.attr({ fill : "#FF39A6", stroke : "#696969", strokeWidth : 1});
	};
	this.port.onNormal = function() {
		_g.graphic.attr({ fill : "#D3D3D3", stroke : "#696969", strokeWidth : 1});
	};
};
...
retro.view.Thema.fill = "#F4F4F4";
retro.view.Thema.stroke = "#696969";
retro.view.Thema.strokeWidth = 1;
retro.view.Thema.fontFamily = "MyriadPro-Regular";
retro.view.Thema.fontSize = "12pt";
retro.view.Thema.fontFill = "#696969";
retro.view.Thema.jobFill = "#F4F4F4";
retro.view.Thema.jobStroke = "#696969";
retro.view.Thema.jobStrokeWidth = 1;
retro.view.Thema.jobFontFamily = "MyriadPro-Regular";
retro.view.Thema.jobFontSize = "12pt";
retro.view.Thema.jobFontFill = "#696969";
retro.view.Thema.inputPortFill = "#F4F4F4";
retro.view.Thema.inputPortStroke = "#696969";
retro.view.Thema.inputPortStrokeWidth = 1;
retro.view.Thema.inputPortFontFamily = "MyriadPro-Regular";
retro.view.Thema.inputPortFontSize = "12pt";
retro.view.Thema.inputPortFontFill = "#696969";
retro.view.Thema.outputPortFill = "#D3D3D3";
retro.view.Thema.outputPortStroke = "#696969";
retro.view.Thema.outputPortStrokeWidth = 1;
retro.view.Thema.outputPortFontFamily = "MyriadPro-Regular";
retro.view.Thema.outputPortFontSize = "12pt";
...
retro.view.Thema.consoleFontFamily = "MyriadPro-Regular";
retro.view.Thema.consoleFontSize = "12pt";
retro.view.Thema.consoleFontFill = "#696969";
...
retro.view.Thema.constantValueFontFamily = "MyriadPro-Regular";
retro.view.Thema.constantValueFontSize = "12pt";
...
retro.view.Thema.valueCarrierFontFamily = "MyriadPro-Regular";
retro.view.Thema.valueCarrierFontSize = "12pt";
retro.view.Thema.valueCarrierFontFill = "#ffffff";
retro.view.Thema.buttonBackgroundFill = "#F4F4F4";
retro.view.Thema.buttonBackgroundStroke = "#696969";
retro.view.Thema.buttonBackgroundStrokeWidth = 1;
retro.view.Thema.dustboxBackgroundFill = "#F4F4F4";
retro.view.Thema.dustboxBackgroundStroke = "#696969";
retro.view.Thema.dustboxBackgroundStrokeWidth = 1;
retro.view.Thema.playSvgFill = "#ffffff";
retro.view.Thema.playSvgStroke = "#696969";
retro.view.Thema.playSvgStrokeWidth = 1;
retro.view.Thema.playModeFill = "#FF39A6";
retro.view.Thema.playModeStroke = "#FF39A6";
retro.view.Thema.playModeStrokeWidth = 1;
retro.view.Thema.createSvgFill = "#ffffff";
retro.view.Thema.createSvgStroke = "#696969";
retro.view.Thema.createSvgStrokeWidth = 1;
retro.view.Thema.dustboxSvgFill = "#ffffff";
retro.view.Thema.dustboxSvgStroke = "#696969";
retro.view.Thema.dustboxSvgStrokeWidth = 1;
Main.main();
