...
#define INCLUDED_retro_library_core_Filter
...
HX_DECLARE_CLASS3(retro,library,core,Filter)
namespace retro{
namespace library{
namespace core{
...
class HXCPP_CLASS_ATTRIBUTES  Filter_obj : public hx::Object{
	...
	public:
		...
		inline operator ::retro::core::JobComponent_obj *()
			{ return new ::retro::core::JobComponent_delegate_< Filter_obj >(this); }
		hx::Object *__ToInterface(const hx::type_info &inType);
		::String __ToString() const { return HX_CSTRING("Filter"); }
...
#endif /* INCLUDED_retro_library_core_Filter */ 
