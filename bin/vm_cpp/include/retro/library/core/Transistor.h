...
#define INCLUDED_retro_library_core_Transistor
...
HX_DECLARE_CLASS3(retro,library,core,Transistor)
namespace retro{
namespace library{
namespace core{


class HXCPP_CLASS_ATTRIBUTES  Transistor_obj : public hx::Object{
	public:
		typedef hx::Object super;
		typedef Transistor_obj OBJ_;
		Transistor_obj();
		Void __construct();

	public:
		static hx::ObjectPtr< Transistor_obj > __new();
		...
		inline operator ::retro::core::JobComponent_obj *()
			{ return new ::retro::core::JobComponent_delegate_< Transistor_obj >(this); }
		hx::Object *__ToInterface(const hx::type_info &inType);
		::String __ToString() const { return HX_CSTRING("Transistor"); }
...
#endif /* INCLUDED_retro_library_core_Transistor */ 
