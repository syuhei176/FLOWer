...
#define INCLUDED_retro_library_core_Drop
...
HX_DECLARE_CLASS3(retro,library,core,Drop)
namespace retro{
namespace library{
namespace core{


class HXCPP_CLASS_ATTRIBUTES  Drop_obj : public hx::Object{
	public:
		typedef hx::Object super;
		typedef Drop_obj OBJ_;
		Drop_obj();
		Void __construct();

	public:
		static hx::ObjectPtr< Drop_obj > __new();
		...
		inline operator ::retro::core::JobComponent_obj *()
			{ return new ::retro::core::JobComponent_delegate_< Drop_obj >(this); }
		hx::Object *__ToInterface(const hx::type_info &inType);
		::String __ToString() const { return HX_CSTRING("Drop"); }
...
#endif /* INCLUDED_retro_library_core_Drop */ 
