...
#define INCLUDED_retro_library_core_Compare
...
HX_DECLARE_CLASS3(retro,library,core,Compare)
namespace retro{
namespace library{
namespace core{
...
class HXCPP_CLASS_ATTRIBUTES  Compare_obj : public hx::Object{
	...
	public:
		...
		inline operator ::retro::core::JobComponent_obj *()
			{ return new ::retro::core::JobComponent_delegate_< Compare_obj >(this); }
...
#endif /* INCLUDED_retro_library_core_Compare */ 
