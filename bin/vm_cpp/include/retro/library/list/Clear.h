...
#define INCLUDED_retro_library_list_Clear
...
HX_DECLARE_CLASS3(retro,library,list,Clear)
namespace retro{
namespace library{
namespace list{


class HXCPP_CLASS_ATTRIBUTES  Clear_obj : public hx::Object{
	public:
	...
	public:
		static hx::ObjectPtr< Clear_obj > __new();
		...
		inline operator ::retro::core::JobComponent_obj *()
			{ return new ::retro::core::JobComponent_delegate_< Clear_obj >(this); }
		hx::Object *__ToInterface(const hx::type_info &inType);
		::String __ToString() const { return HX_CSTRING("Clear"); }
...
#endif /* INCLUDED_retro_library_list_Clear */ 
