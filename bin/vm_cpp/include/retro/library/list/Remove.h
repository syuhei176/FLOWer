...
#define INCLUDED_retro_library_list_Remove
...
HX_DECLARE_CLASS3(retro,library,list,Remove)
namespace retro{
namespace library{
namespace list{


class HXCPP_CLASS_ATTRIBUTES  Remove_obj : public hx::Object{
	public:
		typedef hx::Object super;
		typedef Remove_obj OBJ_;
		Remove_obj();
		Void __construct();

	public:
		static hx::ObjectPtr< Remove_obj > __new();
		...
		inline operator ::retro::core::JobComponent_obj *()
			{ return new ::retro::core::JobComponent_delegate_< Remove_obj >(this); }
		hx::Object *__ToInterface(const hx::type_info &inType);
		::String __ToString() const { return HX_CSTRING("Remove"); }
...
#endif /* INCLUDED_retro_library_list_Remove */ 
