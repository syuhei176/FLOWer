...
#define INCLUDED_retro_library_list_Last
...
HX_DECLARE_CLASS3(retro,library,list,Last)
namespace retro{
namespace library{
namespace list{


class HXCPP_CLASS_ATTRIBUTES  Last_obj : public hx::Object{
	public:
		typedef hx::Object super;
		typedef Last_obj OBJ_;
		Last_obj();
		Void __construct();

	public:
		static hx::ObjectPtr< Last_obj > __new();
		...
		inline operator ::retro::core::JobComponent_obj *()
			{ return new ::retro::core::JobComponent_delegate_< Last_obj >(this); }
		hx::Object *__ToInterface(const hx::type_info &inType);
		::String __ToString() const { return HX_CSTRING("Last"); }
...
#endif /* INCLUDED_retro_library_list_Last */ 
