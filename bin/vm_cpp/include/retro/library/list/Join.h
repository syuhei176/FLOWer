...
#define INCLUDED_retro_library_list_Join
...
HX_DECLARE_CLASS3(retro,library,list,Join)
namespace retro{
namespace library{
namespace list{
...
class HXCPP_CLASS_ATTRIBUTES  Join_obj : public hx::Object{
	...
	public:
		static hx::ObjectPtr< Join_obj > __new();
		...
		inline operator ::retro::core::JobComponent_obj *()
			{ return new ::retro::core::JobComponent_delegate_< Join_obj >(this); }
		hx::Object *__ToInterface(const hx::type_info &inType);
		::String __ToString() const { return HX_CSTRING("Join"); }
...
#endif /* INCLUDED_retro_library_list_Join */ 
