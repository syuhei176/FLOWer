...
#define INCLUDED_retro_library_math_Sin
...
HX_DECLARE_CLASS3(retro,library,math,Sin)
namespace retro{
namespace library{
namespace math{


class HXCPP_CLASS_ATTRIBUTES  Sin_obj : public hx::Object{
	public:
		typedef hx::Object super;
		typedef Sin_obj OBJ_;
		Sin_obj();
		Void __construct();

	public:
		static hx::ObjectPtr< Sin_obj > __new();
		...
		inline operator ::retro::core::JobComponent_obj *()
			{ return new ::retro::core::JobComponent_delegate_< Sin_obj >(this); }
		hx::Object *__ToInterface(const hx::type_info &inType);
		::String __ToString() const { return HX_CSTRING("Sin"); }
...
#endif /* INCLUDED_retro_library_math_Sin */ 
