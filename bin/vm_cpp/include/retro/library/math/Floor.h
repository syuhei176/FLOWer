...
#define INCLUDED_retro_library_math_Floor
...
HX_DECLARE_CLASS3(retro,library,math,Floor)
namespace retro{
namespace library{
namespace math{
...
class HXCPP_CLASS_ATTRIBUTES  Floor_obj : public hx::Object{
	...
	public:
		...
		inline operator ::retro::core::JobComponent_obj *()
			{ return new ::retro::core::JobComponent_delegate_< Floor_obj >(this); }
		hx::Object *__ToInterface(const hx::type_info &inType);
		::String __ToString() const { return HX_CSTRING("Floor"); }
...
#endif /* INCLUDED_retro_library_math_Floor */ 
