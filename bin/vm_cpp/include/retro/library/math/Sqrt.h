...
#define INCLUDED_retro_library_math_Sqrt
...
HX_DECLARE_CLASS3(retro,library,math,Sqrt)
namespace retro{
namespace library{
namespace math{


class HXCPP_CLASS_ATTRIBUTES  Sqrt_obj : public hx::Object{
	public:
		typedef hx::Object super;
		typedef Sqrt_obj OBJ_;
		Sqrt_obj();
		Void __construct();

	public:
		static hx::ObjectPtr< Sqrt_obj > __new();
		...
		inline operator ::retro::core::JobComponent_obj *()
			{ return new ::retro::core::JobComponent_delegate_< Sqrt_obj >(this); }
		hx::Object *__ToInterface(const hx::type_info &inType);
		::String __ToString() const { return HX_CSTRING("Sqrt"); }
...
#endif /* INCLUDED_retro_library_math_Sqrt */ 
