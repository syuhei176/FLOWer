...
#define INCLUDED_retro_library_math_Random
...
HX_DECLARE_CLASS3(retro,library,math,Random)
namespace retro{
namespace library{
namespace math{
...
class HXCPP_CLASS_ATTRIBUTES  Random_obj : public hx::Object{
	...
	public:
		...
		inline operator ::retro::core::JobComponent_obj *()
			{ return new ::retro::core::JobComponent_delegate_< Random_obj >(this); }
...
#endif /* INCLUDED_retro_library_math_Random */ 
