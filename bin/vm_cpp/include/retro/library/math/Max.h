...
#define INCLUDED_retro_library_math_Max
...
HX_DECLARE_CLASS3(retro,library,math,Max)
namespace retro{
namespace library{
namespace math{
...
class HXCPP_CLASS_ATTRIBUTES  Max_obj : public hx::Object{
	...
	public:
		static hx::ObjectPtr< Max_obj > __new();
		...
		inline operator ::retro::core::JobComponent_obj *()
			{ return new ::retro::core::JobComponent_delegate_< Max_obj >(this); }
		hx::Object *__ToInterface(const hx::type_info &inType);
		::String __ToString() const { return HX_CSTRING("Max"); }
...
#endif /* INCLUDED_retro_library_math_Max */ 
