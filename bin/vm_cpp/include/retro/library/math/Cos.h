...
#define INCLUDED_retro_library_math_Cos
...
HX_DECLARE_CLASS3(retro,library,math,Cos)
namespace retro{
namespace library{
namespace math{


class HXCPP_CLASS_ATTRIBUTES  Cos_obj : public hx::Object{
	public:
		typedef hx::Object super;
		typedef Cos_obj OBJ_;
		Cos_obj();
		Void __construct();

	public:
		static hx::ObjectPtr< Cos_obj > __new();
		...
		inline operator ::retro::core::JobComponent_obj *()
			{ return new ::retro::core::JobComponent_delegate_< Cos_obj >(this); }
		hx::Object *__ToInterface(const hx::type_info &inType);
		::String __ToString() const { return HX_CSTRING("Cos"); }
...
#endif /* INCLUDED_retro_library_math_Cos */ 
