...
#define INCLUDED_retro_library_math_Acos
...
HX_DECLARE_CLASS3(retro,library,math,Acos)
namespace retro{
namespace library{
namespace math{


class HXCPP_CLASS_ATTRIBUTES  Acos_obj : public hx::Object{
	public:
		typedef hx::Object super;
		typedef Acos_obj OBJ_;
		Acos_obj();
		Void __construct();

	public:
		static hx::ObjectPtr< Acos_obj > __new();
		...
		inline operator ::retro::core::JobComponent_obj *()
			{ return new ::retro::core::JobComponent_delegate_< Acos_obj >(this); }
		hx::Object *__ToInterface(const hx::type_info &inType);
		::String __ToString() const { return HX_CSTRING("Acos"); }
...
#endif /* INCLUDED_retro_library_math_Acos */ 
