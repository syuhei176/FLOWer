...
#define INCLUDED_retro_library_math_Atan2
...
HX_DECLARE_CLASS3(retro,library,math,Atan2)
namespace retro{
namespace library{
namespace math{


class HXCPP_CLASS_ATTRIBUTES  Atan2_obj : public hx::Object{
	public:
		typedef hx::Object super;
		typedef Atan2_obj OBJ_;
		Atan2_obj();
		Void __construct();

	public:
		static hx::ObjectPtr< Atan2_obj > __new();
		...
		inline operator ::retro::core::JobComponent_obj *()
			{ return new ::retro::core::JobComponent_delegate_< Atan2_obj >(this); }
		hx::Object *__ToInterface(const hx::type_info &inType);
		::String __ToString() const { return HX_CSTRING("Atan2"); }
...
#endif /* INCLUDED_retro_library_math_Atan2 */ 
