...
#define INCLUDED_retro_library_math_Abs
...
HX_DECLARE_CLASS3(retro,library,math,Abs)
namespace retro{
namespace library{
namespace math{


class HXCPP_CLASS_ATTRIBUTES  Abs_obj : public hx::Object{
	public:
		typedef hx::Object super;
		typedef Abs_obj OBJ_;
		Abs_obj();
		Void __construct();

	public:
		static hx::ObjectPtr< Abs_obj > __new();
		...
		inline operator ::retro::core::JobComponent_obj *()
			{ return new ::retro::core::JobComponent_delegate_< Abs_obj >(this); }
		hx::Object *__ToInterface(const hx::type_info &inType);
		::String __ToString() const { return HX_CSTRING("Abs"); }
...
#endif /* INCLUDED_retro_library_math_Abs */ 
