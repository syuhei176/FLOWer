...
#define INCLUDED_retro_library_string_Substr
...
HX_DECLARE_CLASS3(retro,library,string,Substr)
namespace retro{
namespace library{
namespace string{


class HXCPP_CLASS_ATTRIBUTES  Substr_obj : public hx::Object{
	public:
		typedef hx::Object super;
		typedef Substr_obj OBJ_;
		Substr_obj();
		Void __construct();

	public:
		static hx::ObjectPtr< Substr_obj > __new();
		...
		inline operator ::retro::core::JobComponent_obj *()
			{ return new ::retro::core::JobComponent_delegate_< Substr_obj >(this); }
		hx::Object *__ToInterface(const hx::type_info &inType);
		::String __ToString() const { return HX_CSTRING("Substr"); }
...
#endif /* INCLUDED_retro_library_string_Substr */ 
