...
#define INCLUDED_retro_library_string_Split
...
HX_DECLARE_CLASS3(retro,library,string,Split)
namespace retro{
namespace library{
namespace string{


class HXCPP_CLASS_ATTRIBUTES  Split_obj : public hx::Object{
	public:
		typedef hx::Object super;
		typedef Split_obj OBJ_;
		Split_obj();
		Void __construct();

	public:
		static hx::ObjectPtr< Split_obj > __new();
		...
		inline operator ::retro::core::JobComponent_obj *()
			{ return new ::retro::core::JobComponent_delegate_< Split_obj >(this); }
		hx::Object *__ToInterface(const hx::type_info &inType);
		::String __ToString() const { return HX_CSTRING("Split"); }
...
#endif /* INCLUDED_retro_library_string_Split */ 
