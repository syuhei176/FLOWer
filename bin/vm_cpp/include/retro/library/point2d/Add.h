...
#define INCLUDED_retro_library_point2d_Add
...
HX_DECLARE_CLASS3(retro,library,point2d,Add)
namespace retro{
namespace library{
namespace point2d{


class HXCPP_CLASS_ATTRIBUTES  Add_obj : public hx::Object{
	public:
		typedef hx::Object super;
		typedef Add_obj OBJ_;
		Add_obj();
		Void __construct();

	public:
		static hx::ObjectPtr< Add_obj > __new();
		...
		inline operator ::retro::core::JobComponent_obj *()
			{ return new ::retro::core::JobComponent_delegate_< Add_obj >(this); }
		hx::Object *__ToInterface(const hx::type_info &inType);
		::String __ToString() const { return HX_CSTRING("Add"); }
...
#endif /* INCLUDED_retro_library_point2d_Add */ 
