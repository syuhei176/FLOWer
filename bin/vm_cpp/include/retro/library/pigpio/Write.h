...
#define INCLUDED_retro_library_pigpio_Write
...
HX_DECLARE_CLASS3(retro,library,pigpio,Write)
namespace retro{
namespace library{
namespace pigpio{


class HXCPP_CLASS_ATTRIBUTES  Write_obj : public hx::Object{
	public:
		typedef hx::Object super;
		typedef Write_obj OBJ_;
		Write_obj();
		Void __construct();

	public:
		static hx::ObjectPtr< Write_obj > __new();
		...
		inline operator ::retro::core::JobComponent_obj *()
			{ return new ::retro::core::JobComponent_delegate_< Write_obj >(this); }
		hx::Object *__ToInterface(const hx::type_info &inType);
		::String __ToString() const { return HX_CSTRING("Write"); }
...
#endif /* INCLUDED_retro_library_pigpio_Write */ 
