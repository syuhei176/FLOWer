...
#define INCLUDED_retro_library_sphero_Roll
...
HX_DECLARE_CLASS3(retro,library,sphero,Roll)
namespace retro{
namespace library{
namespace sphero{


class HXCPP_CLASS_ATTRIBUTES  Roll_obj : public hx::Object{
	public:
		typedef hx::Object super;
		typedef Roll_obj OBJ_;
		Roll_obj();
		Void __construct();

	public:
		static hx::ObjectPtr< Roll_obj > __new();
		...
		inline operator ::retro::core::JobComponent_obj *()
			{ return new ::retro::core::JobComponent_delegate_< Roll_obj >(this); }
		hx::Object *__ToInterface(const hx::type_info &inType);
		::String __ToString() const { return HX_CSTRING("Roll"); }
...
#endif /* INCLUDED_retro_library_sphero_Roll */ 
