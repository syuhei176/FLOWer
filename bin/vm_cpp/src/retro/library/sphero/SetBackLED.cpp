...
Void SetBackLED_obj::__construct()
{
HX_STACK_PUSH("SetBackLED::new","retro/library/sphero/SetBackLED.hx",17);
{
	HX_STACK_LINE(18)
	this->name = HX_CSTRING("SetBackLED");
	HX_STACK_LINE(19)
...
SetBackLED_obj::~SetBackLED_obj() { }

Dynamic SetBackLED_obj::__CreateEmpty() { return  new SetBackLED_obj; }
hx::ObjectPtr< SetBackLED_obj > SetBackLED_obj::__new()
{  hx::ObjectPtr< SetBackLED_obj > result = new SetBackLED_obj();
	result->__construct();
	return result;}

Dynamic SetBackLED_obj::__Create(hx::DynamicArray inArgs)
{  hx::ObjectPtr< SetBackLED_obj > result = new SetBackLED_obj();
	result->__construct();
	return result;}

hx::Object *SetBackLED_obj::__ToInterface(const hx::type_info &inType) {
	if (inType==typeid( ::retro::core::JobComponent_obj)) return operator ::retro::core::JobComponent_obj *();
	return super::__ToInterface(inType);
}

::String SetBackLED_obj::getModuleName( ){
	HX_STACK_PUSH("SetBackLED::getModuleName","retro/library/sphero/SetBackLED.hx",36);
	HX_STACK_THIS(this);
	HX_STACK_LINE(36)
	return HX_CSTRING("sphero.SetBackLED");
}


HX_DEFINE_DYNAMIC_FUNC0(SetBackLED_obj,getModuleName,return )

Void SetBackLED_obj::onInputRecieved( ::retro::core::Params params,Dynamic cb){
{
		HX_STACK_PUSH("SetBackLED::onInputRecieved","retro/library/sphero/SetBackLED.hx",25);
		HX_STACK_THIS(this);
...
HX_DEFINE_DYNAMIC_FUNC2(SetBackLED_obj,onInputRecieved,(void))
...
void SetBackLED_obj::__Mark(HX_MARK_PARAMS)
{
	HX_MARK_BEGIN_CLASS(SetBackLED);
...
void SetBackLED_obj::__Visit(HX_VISIT_PARAMS)
{
...
Dynamic SetBackLED_obj::__Field(const ::String &inName,bool inCallProp)
{
...
Dynamic SetBackLED_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 4:
...
void SetBackLED_obj::__GetFields(Array< ::String> &outFields)
{
...
static void sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(SetBackLED_obj::__mClass,"__mClass");
};

static void sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(SetBackLED_obj::__mClass,"__mClass");
};

Class SetBackLED_obj::__mClass;

void SetBackLED_obj::__register()
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("retro.library.sphero.SetBackLED"), hx::TCanCast< SetBackLED_obj> ,sStaticFields,sMemberFields,
	&__CreateEmpty, &__Create,
	&super::__SGetClass(), 0, sMarkStatics, sVisitStatics);
}

void SetBackLED_obj::__boot()
{
}
