...
Void SetHeading_obj::__construct()
{
HX_STACK_PUSH("SetHeading::new","retro/library/sphero/SetHeading.hx",17);
{
	HX_STACK_LINE(18)
	this->name = HX_CSTRING("SetHeading");
	HX_STACK_LINE(19)
	...
	HX_STACK_LINE(22)
	this->inputs->add(HX_CSTRING("r"),::retro::pub::RetroType_obj::RNumber);
	HX_STACK_LINE(23)
...
SetHeading_obj::~SetHeading_obj() { }

Dynamic SetHeading_obj::__CreateEmpty() { return  new SetHeading_obj; }
hx::ObjectPtr< SetHeading_obj > SetHeading_obj::__new()
{  hx::ObjectPtr< SetHeading_obj > result = new SetHeading_obj();
	result->__construct();
	return result;}

Dynamic SetHeading_obj::__Create(hx::DynamicArray inArgs)
{  hx::ObjectPtr< SetHeading_obj > result = new SetHeading_obj();
	result->__construct();
	return result;}

hx::Object *SetHeading_obj::__ToInterface(const hx::type_info &inType) {
	if (inType==typeid( ::retro::core::JobComponent_obj)) return operator ::retro::core::JobComponent_obj *();
	return super::__ToInterface(inType);
}

::String SetHeading_obj::getModuleName( ){
	HX_STACK_PUSH("SetHeading::getModuleName","retro/library/sphero/SetHeading.hx",37);
	HX_STACK_THIS(this);
	HX_STACK_LINE(37)
	return HX_CSTRING("sphero.SetHeading");
}


HX_DEFINE_DYNAMIC_FUNC0(SetHeading_obj,getModuleName,return )

Void SetHeading_obj::onInputRecieved( ::retro::core::Params params,Dynamic cb){
{
		HX_STACK_PUSH("SetHeading::onInputRecieved","retro/library/sphero/SetHeading.hx",26);
		HX_STACK_THIS(this);
...
HX_DEFINE_DYNAMIC_FUNC2(SetHeading_obj,onInputRecieved,(void))
...
void SetHeading_obj::__Mark(HX_MARK_PARAMS)
{
	HX_MARK_BEGIN_CLASS(SetHeading);
...
void SetHeading_obj::__Visit(HX_VISIT_PARAMS)
{
...
Dynamic SetHeading_obj::__Field(const ::String &inName,bool inCallProp)
{
...
Dynamic SetHeading_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 4:
...
void SetHeading_obj::__GetFields(Array< ::String> &outFields)
{
...
static void sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(SetHeading_obj::__mClass,"__mClass");
};

static void sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(SetHeading_obj::__mClass,"__mClass");
};

Class SetHeading_obj::__mClass;

void SetHeading_obj::__register()
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("retro.library.sphero.SetHeading"), hx::TCanCast< SetHeading_obj> ,sStaticFields,sMemberFields,
	&__CreateEmpty, &__Create,
	&super::__SGetClass(), 0, sMarkStatics, sVisitStatics);
}

void SetHeading_obj::__boot()
{
}
