...
Void Through_obj::__construct()
{
HX_STACK_PUSH("Through::new","retro/library/core/Through.hx",15);
{
	HX_STACK_LINE(16)
	this->name = HX_CSTRING("Through");
	HX_STACK_LINE(17)
...
Through_obj::~Through_obj() { }

Dynamic Through_obj::__CreateEmpty() { return  new Through_obj; }
hx::ObjectPtr< Through_obj > Through_obj::__new()
{  hx::ObjectPtr< Through_obj > result = new Through_obj();
	result->__construct();
	return result;}

Dynamic Through_obj::__Create(hx::DynamicArray inArgs)
{  hx::ObjectPtr< Through_obj > result = new Through_obj();
	result->__construct();
	return result;}

hx::Object *Through_obj::__ToInterface(const hx::type_info &inType) {
	if (inType==typeid( ::retro::core::JobComponent_obj)) return operator ::retro::core::JobComponent_obj *();
	return super::__ToInterface(inType);
}

::String Through_obj::getModuleName( ){
	HX_STACK_PUSH("Through::getModuleName","retro/library/core/Through.hx",34);
	HX_STACK_THIS(this);
	HX_STACK_LINE(34)
	return HX_CSTRING("core.Through");
}


HX_DEFINE_DYNAMIC_FUNC0(Through_obj,getModuleName,return )

Void Through_obj::onInputRecieved( ::retro::core::Params params,Dynamic cb){
{
		HX_STACK_PUSH("Through::onInputRecieved","retro/library/core/Through.hx",23);
		HX_STACK_THIS(this);
...
HX_DEFINE_DYNAMIC_FUNC2(Through_obj,onInputRecieved,(void))
...
void Through_obj::__Mark(HX_MARK_PARAMS)
{
	HX_MARK_BEGIN_CLASS(Through);
...
void Through_obj::__Visit(HX_VISIT_PARAMS)
{
...
Dynamic Through_obj::__Field(const ::String &inName,bool inCallProp)
{
...
Dynamic Through_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 4:
...
void Through_obj::__GetFields(Array< ::String> &outFields)
{
...
static void sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(Through_obj::__mClass,"__mClass");
};

static void sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(Through_obj::__mClass,"__mClass");
};

Class Through_obj::__mClass;

void Through_obj::__register()
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("retro.library.core.Through"), hx::TCanCast< Through_obj> ,sStaticFields,sMemberFields,
	&__CreateEmpty, &__Create,
	&super::__SGetClass(), 0, sMarkStatics, sVisitStatics);
}

void Through_obj::__boot()
{
}
