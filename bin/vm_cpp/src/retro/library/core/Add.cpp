...
{
HX_STACK_PUSH("Add::new","retro/library/core/Add.hx",15);
{
	HX_STACK_LINE(16)
...
::String Add_obj::getModuleName( ){
	HX_STACK_PUSH("Add::getModuleName","retro/library/core/Add.hx",36);
	HX_STACK_THIS(this);
	HX_STACK_LINE(36)
	return HX_CSTRING("core.Add");
}
...
{
		HX_STACK_PUSH("Add::onInputRecieved","retro/library/core/Add.hx",24);
		HX_STACK_THIS(this);
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("retro.library.core.Add"), hx::TCanCast< Add_obj> ,sStaticFields,sMemberFields,
