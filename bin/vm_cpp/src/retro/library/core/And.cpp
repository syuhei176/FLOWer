...
Void And_obj::__construct()
{
HX_STACK_PUSH("And::new","retro/library/core/And.hx",15);
{
	HX_STACK_LINE(16)
	this->name = HX_CSTRING("And");
	HX_STACK_LINE(17)
...
Dynamic And_obj::__CreateEmpty() { return  new And_obj; }
hx::ObjectPtr< And_obj > And_obj::__new()
{  hx::ObjectPtr< And_obj > result = new And_obj();
	result->__construct();
	return result;}

Dynamic And_obj::__Create(hx::DynamicArray inArgs)
{  hx::ObjectPtr< And_obj > result = new And_obj();
	result->__construct();
	return result;}

hx::Object *And_obj::__ToInterface(const hx::type_info &inType) {
	if (inType==typeid( ::retro::core::JobComponent_obj)) return operator ::retro::core::JobComponent_obj *();
	return super::__ToInterface(inType);
}

::String And_obj::getModuleName( ){
	HX_STACK_PUSH("And::getModuleName","retro/library/core/And.hx",36);
	HX_STACK_THIS(this);
	HX_STACK_LINE(36)
	return HX_CSTRING("core.And");
}


HX_DEFINE_DYNAMIC_FUNC0(And_obj,getModuleName,return )

Void And_obj::onInputRecieved( ::retro::core::Params params,Dynamic cb){
{
		HX_STACK_PUSH("And::onInputRecieved","retro/library/core/And.hx",24);
		HX_STACK_THIS(this);
...
HX_DEFINE_DYNAMIC_FUNC2(And_obj,onInputRecieved,(void))
...
void And_obj::__Mark(HX_MARK_PARAMS)
{
	HX_MARK_BEGIN_CLASS(And);
...
void And_obj::__Visit(HX_VISIT_PARAMS)
{
...
Dynamic And_obj::__Field(const ::String &inName,bool inCallProp)
{
...
Dynamic And_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 4:
...
void And_obj::__GetFields(Array< ::String> &outFields)
{
...
static void sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(And_obj::__mClass,"__mClass");
};

static void sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(And_obj::__mClass,"__mClass");
};

Class And_obj::__mClass;

void And_obj::__register()
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("retro.library.core.And"), hx::TCanCast< And_obj> ,sStaticFields,sMemberFields,
