...
Void First_obj::__construct()
{
HX_STACK_PUSH("First::new","retro/library/list/First.hx",17);
{
	HX_STACK_LINE(18)
	this->name = HX_CSTRING("First");
	HX_STACK_LINE(19)
...
Dynamic First_obj::__CreateEmpty() { return  new First_obj; }
hx::ObjectPtr< First_obj > First_obj::__new()
{  hx::ObjectPtr< First_obj > result = new First_obj();
	result->__construct();
	return result;}

Dynamic First_obj::__Create(hx::DynamicArray inArgs)
{  hx::ObjectPtr< First_obj > result = new First_obj();
	result->__construct();
	return result;}

hx::Object *First_obj::__ToInterface(const hx::type_info &inType) {
	if (inType==typeid( ::retro::core::JobComponent_obj)) return operator ::retro::core::JobComponent_obj *();
	return super::__ToInterface(inType);
}

::String First_obj::getModuleName( ){
	HX_STACK_PUSH("First::getModuleName","retro/library/list/First.hx",36);
	HX_STACK_THIS(this);
	HX_STACK_LINE(36)
	return HX_CSTRING("list.First");
}


HX_DEFINE_DYNAMIC_FUNC0(First_obj,getModuleName,return )

Void First_obj::onInputRecieved( ::retro::core::Params params,Dynamic cb){
{
		HX_STACK_PUSH("First::onInputRecieved","retro/library/list/First.hx",25);
		HX_STACK_THIS(this);
...
HX_DEFINE_DYNAMIC_FUNC2(First_obj,onInputRecieved,(void))
...
void First_obj::__Mark(HX_MARK_PARAMS)
{
	HX_MARK_BEGIN_CLASS(First);
...
void First_obj::__Visit(HX_VISIT_PARAMS)
{
...
Dynamic First_obj::__Field(const ::String &inName,bool inCallProp)
{
...
Dynamic First_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 4:
...
void First_obj::__GetFields(Array< ::String> &outFields)
{
...
static void sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(First_obj::__mClass,"__mClass");
};

static void sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(First_obj::__mClass,"__mClass");
};

Class First_obj::__mClass;

void First_obj::__register()
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("retro.library.list.First"), hx::TCanCast< First_obj> ,sStaticFields,sMemberFields,
	&__CreateEmpty, &__Create,
	&super::__SGetClass(), 0, sMarkStatics, sVisitStatics);
}

void First_obj::__boot()
{
}
