...
{
HX_STACK_PUSH("Pop::new","retro/library/list/Pop.hx",17);
{
	HX_STACK_LINE(18)
...
::String Pop_obj::getModuleName( ){
	HX_STACK_PUSH("Pop::getModuleName","retro/library/list/Pop.hx",36);
	HX_STACK_THIS(this);
	HX_STACK_LINE(36)
	return HX_CSTRING("list.Pop");
}
...
{
		HX_STACK_PUSH("Pop::onInputRecieved","retro/library/list/Pop.hx",25);
		HX_STACK_THIS(this);
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("retro.library.list.Pop"), hx::TCanCast< Pop_obj> ,sStaticFields,sMemberFields,
