...
{
HX_STACK_PUSH("Join::new","retro/library/list/Join.hx",17);
{
	HX_STACK_LINE(18)
	this->name = HX_CSTRING("Join");
	HX_STACK_LINE(19)
...
hx::ObjectPtr< Join_obj > Join_obj::__new()
{  hx::ObjectPtr< Join_obj > result = new Join_obj();
	result->__construct();
	return result;}
...
hx::Object *Join_obj::__ToInterface(const hx::type_info &inType) {
	if (inType==typeid( ::retro::core::JobComponent_obj)) return operator ::retro::core::JobComponent_obj *();
	return super::__ToInterface(inType);
}

::String Join_obj::getModuleName( ){
	HX_STACK_PUSH("Join::getModuleName","retro/library/list/Join.hx",37);
	HX_STACK_THIS(this);
	HX_STACK_LINE(37)
	return HX_CSTRING("list.Join");
}


HX_DEFINE_DYNAMIC_FUNC0(Join_obj,getModuleName,return )

Void Join_obj::onInputRecieved( ::retro::core::Params params,Dynamic cb){
{
		HX_STACK_PUSH("Join::onInputRecieved","retro/library/list/Join.hx",26);
		HX_STACK_THIS(this);
...
HX_DEFINE_DYNAMIC_FUNC2(Join_obj,onInputRecieved,(void))
...
Dynamic Join_obj::__Field(const ::String &inName,bool inCallProp)
{
...
Dynamic Join_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 4:
...
static void sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(Join_obj::__mClass,"__mClass");
};

static void sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(Join_obj::__mClass,"__mClass");
};

Class Join_obj::__mClass;

void Join_obj::__register()
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("retro.library.list.Join"), hx::TCanCast< Join_obj> ,sStaticFields,sMemberFields,
	&__CreateEmpty, &__Create,
	&super::__SGetClass(), 0, sMarkStatics, sVisitStatics);
}

void Join_obj::__boot()
{
}
