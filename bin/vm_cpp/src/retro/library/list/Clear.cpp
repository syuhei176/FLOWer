...
Void Clear_obj::__construct()
{
HX_STACK_PUSH("Clear::new","retro/library/list/Clear.hx",17);
{
	HX_STACK_LINE(18)
	this->name = HX_CSTRING("Clear");
	HX_STACK_LINE(19)
...
Dynamic Clear_obj::__CreateEmpty() { return  new Clear_obj; }
hx::ObjectPtr< Clear_obj > Clear_obj::__new()
{  hx::ObjectPtr< Clear_obj > result = new Clear_obj();
	result->__construct();
	return result;}

Dynamic Clear_obj::__Create(hx::DynamicArray inArgs)
{  hx::ObjectPtr< Clear_obj > result = new Clear_obj();
	result->__construct();
	return result;}

hx::Object *Clear_obj::__ToInterface(const hx::type_info &inType) {
	if (inType==typeid( ::retro::core::JobComponent_obj)) return operator ::retro::core::JobComponent_obj *();
	return super::__ToInterface(inType);
}

::String Clear_obj::getModuleName( ){
	HX_STACK_PUSH("Clear::getModuleName","retro/library/list/Clear.hx",36);
	HX_STACK_THIS(this);
	HX_STACK_LINE(36)
	return HX_CSTRING("list.Clear");
}


HX_DEFINE_DYNAMIC_FUNC0(Clear_obj,getModuleName,return )

Void Clear_obj::onInputRecieved( ::retro::core::Params params,Dynamic cb){
{
		HX_STACK_PUSH("Clear::onInputRecieved","retro/library/list/Clear.hx",25);
		HX_STACK_THIS(this);
...
HX_DEFINE_DYNAMIC_FUNC2(Clear_obj,onInputRecieved,(void))
...
void Clear_obj::__Mark(HX_MARK_PARAMS)
{
	HX_MARK_BEGIN_CLASS(Clear);
...
void Clear_obj::__Visit(HX_VISIT_PARAMS)
{
...
Dynamic Clear_obj::__Field(const ::String &inName,bool inCallProp)
{
...
Dynamic Clear_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 4:
...
void Clear_obj::__GetFields(Array< ::String> &outFields)
{
...
static void sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(Clear_obj::__mClass,"__mClass");
};

static void sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(Clear_obj::__mClass,"__mClass");
};
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("retro.library.list.Clear"), hx::TCanCast< Clear_obj> ,sStaticFields,sMemberFields,
