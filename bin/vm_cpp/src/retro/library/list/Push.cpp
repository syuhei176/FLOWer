...
{
HX_STACK_PUSH("Push::new","retro/library/list/Push.hx",17);
{
	HX_STACK_LINE(18)
	...
	HX_STACK_LINE(22)
	this->inputs->add(HX_CSTRING("item"),::retro::pub::RetroType_obj::RNumber);
	HX_STACK_LINE(23)
...
::String Push_obj::getModuleName( ){
	HX_STACK_PUSH("Push::getModuleName","retro/library/list/Push.hx",37);
	HX_STACK_THIS(this);
	HX_STACK_LINE(37)
	return HX_CSTRING("list.Push");
}
...
{
		HX_STACK_PUSH("Push::onInputRecieved","retro/library/list/Push.hx",26);
		HX_STACK_THIS(this);
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("retro.library.list.Push"), hx::TCanCast< Push_obj> ,sStaticFields,sMemberFields,
