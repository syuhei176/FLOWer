...
Void Remove_obj::__construct()
{
HX_STACK_PUSH("Remove::new","retro/library/list/Remove.hx",17);
{
	HX_STACK_LINE(18)
	this->name = HX_CSTRING("Remove");
	HX_STACK_LINE(19)
...
Dynamic Remove_obj::__CreateEmpty() { return  new Remove_obj; }
hx::ObjectPtr< Remove_obj > Remove_obj::__new()
{  hx::ObjectPtr< Remove_obj > result = new Remove_obj();
	result->__construct();
	return result;}

Dynamic Remove_obj::__Create(hx::DynamicArray inArgs)
{  hx::ObjectPtr< Remove_obj > result = new Remove_obj();
	result->__construct();
	return result;}

hx::Object *Remove_obj::__ToInterface(const hx::type_info &inType) {
	if (inType==typeid( ::retro::core::JobComponent_obj)) return operator ::retro::core::JobComponent_obj *();
	return super::__ToInterface(inType);
}

::String Remove_obj::getModuleName( ){
	HX_STACK_PUSH("Remove::getModuleName","retro/library/list/Remove.hx",37);
	HX_STACK_THIS(this);
	HX_STACK_LINE(37)
	return HX_CSTRING("list.Remove");
}


HX_DEFINE_DYNAMIC_FUNC0(Remove_obj,getModuleName,return )

Void Remove_obj::onInputRecieved( ::retro::core::Params params,Dynamic cb){
{
		HX_STACK_PUSH("Remove::onInputRecieved","retro/library/list/Remove.hx",26);
		HX_STACK_THIS(this);
...
HX_DEFINE_DYNAMIC_FUNC2(Remove_obj,onInputRecieved,(void))
...
void Remove_obj::__Mark(HX_MARK_PARAMS)
{
	HX_MARK_BEGIN_CLASS(Remove);
...
void Remove_obj::__Visit(HX_VISIT_PARAMS)
{
...
Dynamic Remove_obj::__Field(const ::String &inName,bool inCallProp)
{
...
Dynamic Remove_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 4:
...
void Remove_obj::__GetFields(Array< ::String> &outFields)
{
...
static void sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(Remove_obj::__mClass,"__mClass");
};

static void sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(Remove_obj::__mClass,"__mClass");
};

Class Remove_obj::__mClass;

void Remove_obj::__register()
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("retro.library.list.Remove"), hx::TCanCast< Remove_obj> ,sStaticFields,sMemberFields,
	&__CreateEmpty, &__Create,
	&super::__SGetClass(), 0, sMarkStatics, sVisitStatics);
}

void Remove_obj::__boot()
{
}
