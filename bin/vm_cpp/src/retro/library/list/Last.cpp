...
Void Last_obj::__construct()
{
HX_STACK_PUSH("Last::new","retro/library/list/Last.hx",17);
{
	HX_STACK_LINE(18)
	this->name = HX_CSTRING("Last");
	HX_STACK_LINE(19)
...
Dynamic Last_obj::__CreateEmpty() { return  new Last_obj; }
hx::ObjectPtr< Last_obj > Last_obj::__new()
{  hx::ObjectPtr< Last_obj > result = new Last_obj();
	result->__construct();
	return result;}

Dynamic Last_obj::__Create(hx::DynamicArray inArgs)
{  hx::ObjectPtr< Last_obj > result = new Last_obj();
	result->__construct();
	return result;}

hx::Object *Last_obj::__ToInterface(const hx::type_info &inType) {
	if (inType==typeid( ::retro::core::JobComponent_obj)) return operator ::retro::core::JobComponent_obj *();
	return super::__ToInterface(inType);
}

::String Last_obj::getModuleName( ){
	HX_STACK_PUSH("Last::getModuleName","retro/library/list/Last.hx",36);
	HX_STACK_THIS(this);
	HX_STACK_LINE(36)
	return HX_CSTRING("list.Last");
}


HX_DEFINE_DYNAMIC_FUNC0(Last_obj,getModuleName,return )

Void Last_obj::onInputRecieved( ::retro::core::Params params,Dynamic cb){
{
		HX_STACK_PUSH("Last::onInputRecieved","retro/library/list/Last.hx",25);
		HX_STACK_THIS(this);
...
HX_DEFINE_DYNAMIC_FUNC2(Last_obj,onInputRecieved,(void))
...
void Last_obj::__Mark(HX_MARK_PARAMS)
{
	HX_MARK_BEGIN_CLASS(Last);
...
void Last_obj::__Visit(HX_VISIT_PARAMS)
{
...
Dynamic Last_obj::__Field(const ::String &inName,bool inCallProp)
{
...
Dynamic Last_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 4:
...
void Last_obj::__GetFields(Array< ::String> &outFields)
{
...
static void sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(Last_obj::__mClass,"__mClass");
};

static void sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(Last_obj::__mClass,"__mClass");
};

Class Last_obj::__mClass;

void Last_obj::__register()
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("retro.library.list.Last"), hx::TCanCast< Last_obj> ,sStaticFields,sMemberFields,
	&__CreateEmpty, &__Create,
	&super::__SGetClass(), 0, sMarkStatics, sVisitStatics);
}

void Last_obj::__boot()
{
}
