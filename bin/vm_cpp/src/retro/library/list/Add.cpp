...
{
HX_STACK_PUSH("Add::new","retro/library/list/Add.hx",17);
{
	HX_STACK_LINE(18)
...
::String Add_obj::getModuleName( ){
	HX_STACK_PUSH("Add::getModuleName","retro/library/list/Add.hx",37);
	HX_STACK_THIS(this);
	HX_STACK_LINE(37)
	return HX_CSTRING("list.Add");
}
...
{
		HX_STACK_PUSH("Add::onInputRecieved","retro/library/list/Add.hx",26);
		HX_STACK_THIS(this);
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("retro.library.list.Add"), hx::TCanCast< Add_obj> ,sStaticFields,sMemberFields,
