...
{
HX_STACK_PUSH("Length::new","retro/library/list/Length.hx",17);
{
	HX_STACK_LINE(18)
...
::String Length_obj::getModuleName( ){
	HX_STACK_PUSH("Length::getModuleName","retro/library/list/Length.hx",36);
	HX_STACK_THIS(this);
	HX_STACK_LINE(36)
	return HX_CSTRING("list.Length");
}
...
{
		HX_STACK_PUSH("Length::onInputRecieved","retro/library/list/Length.hx",25);
		HX_STACK_THIS(this);
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("retro.library.list.Length"), hx::TCanCast< Length_obj> ,sStaticFields,sMemberFields,
