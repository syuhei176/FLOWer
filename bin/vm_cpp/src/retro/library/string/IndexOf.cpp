...
Void IndexOf_obj::__construct()
{
HX_STACK_PUSH("IndexOf::new","retro/library/string/IndexOf.hx",17);
{
	HX_STACK_LINE(18)
	this->name = HX_CSTRING("IndexOf");
	HX_STACK_LINE(19)
...
IndexOf_obj::~IndexOf_obj() { }

Dynamic IndexOf_obj::__CreateEmpty() { return  new IndexOf_obj; }
hx::ObjectPtr< IndexOf_obj > IndexOf_obj::__new()
{  hx::ObjectPtr< IndexOf_obj > result = new IndexOf_obj();
	result->__construct();
	return result;}

Dynamic IndexOf_obj::__Create(hx::DynamicArray inArgs)
{  hx::ObjectPtr< IndexOf_obj > result = new IndexOf_obj();
	result->__construct();
	return result;}

hx::Object *IndexOf_obj::__ToInterface(const hx::type_info &inType) {
	if (inType==typeid( ::retro::core::JobComponent_obj)) return operator ::retro::core::JobComponent_obj *();
	return super::__ToInterface(inType);
}

::String IndexOf_obj::getModuleName( ){
	HX_STACK_PUSH("IndexOf::getModuleName","retro/library/string/IndexOf.hx",37);
	HX_STACK_THIS(this);
	HX_STACK_LINE(37)
	return HX_CSTRING("string.IndexOf");
}


HX_DEFINE_DYNAMIC_FUNC0(IndexOf_obj,getModuleName,return )

Void IndexOf_obj::onInputRecieved( ::retro::core::Params params,Dynamic cb){
{
		HX_STACK_PUSH("IndexOf::onInputRecieved","retro/library/string/IndexOf.hx",26);
		HX_STACK_THIS(this);
...
HX_DEFINE_DYNAMIC_FUNC2(IndexOf_obj,onInputRecieved,(void))
...
void IndexOf_obj::__Mark(HX_MARK_PARAMS)
{
	HX_MARK_BEGIN_CLASS(IndexOf);
...
void IndexOf_obj::__Visit(HX_VISIT_PARAMS)
{
...
Dynamic IndexOf_obj::__Field(const ::String &inName,bool inCallProp)
{
...
Dynamic IndexOf_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 4:
...
void IndexOf_obj::__GetFields(Array< ::String> &outFields)
{
...
static void sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(IndexOf_obj::__mClass,"__mClass");
};

static void sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(IndexOf_obj::__mClass,"__mClass");
};

Class IndexOf_obj::__mClass;

void IndexOf_obj::__register()
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("retro.library.string.IndexOf"), hx::TCanCast< IndexOf_obj> ,sStaticFields,sMemberFields,
	&__CreateEmpty, &__Create,
	&super::__SGetClass(), 0, sMarkStatics, sVisitStatics);
}

void IndexOf_obj::__boot()
{
}
