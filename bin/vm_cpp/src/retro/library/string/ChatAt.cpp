...
Void ChatAt_obj::__construct()
{
HX_STACK_PUSH("ChatAt::new","retro/library/string/ChatAt.hx",17);
{
	HX_STACK_LINE(18)
	this->name = HX_CSTRING("ChatAt");
	HX_STACK_LINE(19)
...
ChatAt_obj::~ChatAt_obj() { }

Dynamic ChatAt_obj::__CreateEmpty() { return  new ChatAt_obj; }
hx::ObjectPtr< ChatAt_obj > ChatAt_obj::__new()
{  hx::ObjectPtr< ChatAt_obj > result = new ChatAt_obj();
	result->__construct();
	return result;}

Dynamic ChatAt_obj::__Create(hx::DynamicArray inArgs)
{  hx::ObjectPtr< ChatAt_obj > result = new ChatAt_obj();
	result->__construct();
	return result;}

hx::Object *ChatAt_obj::__ToInterface(const hx::type_info &inType) {
	if (inType==typeid( ::retro::core::JobComponent_obj)) return operator ::retro::core::JobComponent_obj *();
	return super::__ToInterface(inType);
}

::String ChatAt_obj::getModuleName( ){
	HX_STACK_PUSH("ChatAt::getModuleName","retro/library/string/ChatAt.hx",37);
	HX_STACK_THIS(this);
	HX_STACK_LINE(37)
	return HX_CSTRING("string.ChatAt");
}


HX_DEFINE_DYNAMIC_FUNC0(ChatAt_obj,getModuleName,return )

Void ChatAt_obj::onInputRecieved( ::retro::core::Params params,Dynamic cb){
{
		HX_STACK_PUSH("ChatAt::onInputRecieved","retro/library/string/ChatAt.hx",26);
		HX_STACK_THIS(this);
...
HX_DEFINE_DYNAMIC_FUNC2(ChatAt_obj,onInputRecieved,(void))
...
void ChatAt_obj::__Mark(HX_MARK_PARAMS)
{
	HX_MARK_BEGIN_CLASS(ChatAt);
...
void ChatAt_obj::__Visit(HX_VISIT_PARAMS)
{
...
Dynamic ChatAt_obj::__Field(const ::String &inName,bool inCallProp)
{
...
Dynamic ChatAt_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 4:
...
void ChatAt_obj::__GetFields(Array< ::String> &outFields)
{
...
static void sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(ChatAt_obj::__mClass,"__mClass");
};

static void sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(ChatAt_obj::__mClass,"__mClass");
};

Class ChatAt_obj::__mClass;

void ChatAt_obj::__register()
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("retro.library.string.ChatAt"), hx::TCanCast< ChatAt_obj> ,sStaticFields,sMemberFields,
	&__CreateEmpty, &__Create,
	&super::__SGetClass(), 0, sMarkStatics, sVisitStatics);
}

void ChatAt_obj::__boot()
{
}
