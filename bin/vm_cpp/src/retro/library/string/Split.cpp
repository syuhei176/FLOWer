...
Void Split_obj::__construct()
{
HX_STACK_PUSH("Split::new","retro/library/string/Split.hx",17);
{
	HX_STACK_LINE(18)
	this->name = HX_CSTRING("Split");
	HX_STACK_LINE(19)
...
Dynamic Split_obj::__CreateEmpty() { return  new Split_obj; }
hx::ObjectPtr< Split_obj > Split_obj::__new()
{  hx::ObjectPtr< Split_obj > result = new Split_obj();
	result->__construct();
	return result;}

Dynamic Split_obj::__Create(hx::DynamicArray inArgs)
{  hx::ObjectPtr< Split_obj > result = new Split_obj();
	result->__construct();
	return result;}

hx::Object *Split_obj::__ToInterface(const hx::type_info &inType) {
	if (inType==typeid( ::retro::core::JobComponent_obj)) return operator ::retro::core::JobComponent_obj *();
	return super::__ToInterface(inType);
}

::String Split_obj::getModuleName( ){
	HX_STACK_PUSH("Split::getModuleName","retro/library/string/Split.hx",36);
	HX_STACK_THIS(this);
	HX_STACK_LINE(36)
	return HX_CSTRING("string.Split");
}


HX_DEFINE_DYNAMIC_FUNC0(Split_obj,getModuleName,return )

Void Split_obj::onInputRecieved( ::retro::core::Params params,Dynamic cb){
{
		HX_STACK_PUSH("Split::onInputRecieved","retro/library/string/Split.hx",25);
		HX_STACK_THIS(this);
...
HX_DEFINE_DYNAMIC_FUNC2(Split_obj,onInputRecieved,(void))
...
void Split_obj::__Mark(HX_MARK_PARAMS)
{
	HX_MARK_BEGIN_CLASS(Split);
...
void Split_obj::__Visit(HX_VISIT_PARAMS)
{
...
Dynamic Split_obj::__Field(const ::String &inName,bool inCallProp)
{
...
Dynamic Split_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 4:
...
void Split_obj::__GetFields(Array< ::String> &outFields)
{
...
static void sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(Split_obj::__mClass,"__mClass");
};

static void sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(Split_obj::__mClass,"__mClass");
};

Class Split_obj::__mClass;

void Split_obj::__register()
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("retro.library.string.Split"), hx::TCanCast< Split_obj> ,sStaticFields,sMemberFields,
	&__CreateEmpty, &__Create,
	&super::__SGetClass(), 0, sMarkStatics, sVisitStatics);
}

void Split_obj::__boot()
{
}
