...
{
HX_STACK_PUSH("Length::new","retro/library/string/Length.hx",17);
{
	HX_STACK_LINE(18)
...
::String Length_obj::getModuleName( ){
	HX_STACK_PUSH("Length::getModuleName","retro/library/string/Length.hx",36);
	HX_STACK_THIS(this);
	HX_STACK_LINE(36)
	return HX_CSTRING("string.Length");
}
...
{
		HX_STACK_PUSH("Length::onInputRecieved","retro/library/string/Length.hx",25);
		HX_STACK_THIS(this);
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("retro.library.string.Length"), hx::TCanCast< Length_obj> ,sStaticFields,sMemberFields,
