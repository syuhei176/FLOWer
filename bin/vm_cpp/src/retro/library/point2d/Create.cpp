...
{
HX_STACK_PUSH("Create::new","retro/library/point2d/Create.hx",17);
{
	HX_STACK_LINE(18)
...
::String Create_obj::getModuleName( ){
	HX_STACK_PUSH("Create::getModuleName","retro/library/point2d/Create.hx",38);
	HX_STACK_THIS(this);
	HX_STACK_LINE(38)
	return HX_CSTRING("point2d.Create");
}
...
{
		HX_STACK_PUSH("Create::onInputRecieved","retro/library/point2d/Create.hx",27);
		HX_STACK_THIS(this);
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("retro.library.point2d.Create"), hx::TCanCast< Create_obj> ,sStaticFields,sMemberFields,
