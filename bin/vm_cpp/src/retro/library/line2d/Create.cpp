...
{
HX_STACK_PUSH("Create::new","retro/library/line2d/Create.hx",17);
{
	HX_STACK_LINE(18)
	...
	HX_STACK_LINE(21)
	this->inputs->add(HX_CSTRING("line2d"),::retro::pub::RetroType_obj::RNumber);
	HX_STACK_LINE(22)
	this->inputs->add(HX_CSTRING("p1"),::retro::pub::RetroType_obj::RNumber);
	HX_STACK_LINE(23)
	this->inputs->add(HX_CSTRING("p2"),::retro::pub::RetroType_obj::RNumber);
	HX_STACK_LINE(24)
...
::String Create_obj::getModuleName( ){
	HX_STACK_PUSH("Create::getModuleName","retro/library/line2d/Create.hx",38);
	HX_STACK_THIS(this);
	HX_STACK_LINE(38)
	return HX_CSTRING("line2d.Create");
}
...
{
		HX_STACK_PUSH("Create::onInputRecieved","retro/library/line2d/Create.hx",27);
		HX_STACK_THIS(this);
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("retro.library.line2d.Create"), hx::TCanCast< Create_obj> ,sStaticFields,sMemberFields,
