...
{
HX_STACK_PUSH("Distance::new","retro/library/line2d/Distance.hx",17);
{
	HX_STACK_LINE(18)
...
::String Distance_obj::getModuleName( ){
	HX_STACK_PUSH("Distance::getModuleName","retro/library/line2d/Distance.hx",36);
	HX_STACK_THIS(this);
	HX_STACK_LINE(36)
	return HX_CSTRING("line2d.Distance");
}
...
{
		HX_STACK_PUSH("Distance::onInputRecieved","retro/library/line2d/Distance.hx",25);
		HX_STACK_THIS(this);
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("retro.library.line2d.Distance"), hx::TCanCast< Distance_obj> ,sStaticFields,sMemberFields,
