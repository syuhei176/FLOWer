...
Void Atan_obj::__construct()
{
HX_STACK_PUSH("Atan::new","retro/library/math/Atan.hx",17);
{
	HX_STACK_LINE(18)
	this->name = HX_CSTRING("Atan");
	HX_STACK_LINE(19)
...
Dynamic Atan_obj::__CreateEmpty() { return  new Atan_obj; }
hx::ObjectPtr< Atan_obj > Atan_obj::__new()
{  hx::ObjectPtr< Atan_obj > result = new Atan_obj();
	result->__construct();
	return result;}

Dynamic Atan_obj::__Create(hx::DynamicArray inArgs)
{  hx::ObjectPtr< Atan_obj > result = new Atan_obj();
	result->__construct();
	return result;}

hx::Object *Atan_obj::__ToInterface(const hx::type_info &inType) {
	if (inType==typeid( ::retro::core::JobComponent_obj)) return operator ::retro::core::JobComponent_obj *();
	return super::__ToInterface(inType);
}

::String Atan_obj::getModuleName( ){
	HX_STACK_PUSH("Atan::getModuleName","retro/library/math/Atan.hx",36);
	HX_STACK_THIS(this);
	HX_STACK_LINE(36)
	return HX_CSTRING("math.Atan");
}


HX_DEFINE_DYNAMIC_FUNC0(Atan_obj,getModuleName,return )

Void Atan_obj::onInputRecieved( ::retro::core::Params params,Dynamic cb){
{
		HX_STACK_PUSH("Atan::onInputRecieved","retro/library/math/Atan.hx",25);
		HX_STACK_THIS(this);
		...
		HX_STACK_LINE(32)
		result->set(HX_CSTRING("output"),::Math_obj::atan(input->getValue()));
		HX_STACK_LINE(33)
		cb(result).Cast< Void >();
	}
return null();
...
HX_DEFINE_DYNAMIC_FUNC2(Atan_obj,onInputRecieved,(void))
...
void Atan_obj::__Mark(HX_MARK_PARAMS)
{
	HX_MARK_BEGIN_CLASS(Atan);
...
void Atan_obj::__Visit(HX_VISIT_PARAMS)
{
...
Dynamic Atan_obj::__Field(const ::String &inName,bool inCallProp)
{
...
Dynamic Atan_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 4:
...
void Atan_obj::__GetFields(Array< ::String> &outFields)
{
...
static void sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(Atan_obj::__mClass,"__mClass");
};

static void sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(Atan_obj::__mClass,"__mClass");
};

Class Atan_obj::__mClass;

void Atan_obj::__register()
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("retro.library.math.Atan"), hx::TCanCast< Atan_obj> ,sStaticFields,sMemberFields,
	&__CreateEmpty, &__Create,
	&super::__SGetClass(), 0, sMarkStatics, sVisitStatics);
}

void Atan_obj::__boot()
{
}
