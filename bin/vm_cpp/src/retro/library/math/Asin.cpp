...
Void Asin_obj::__construct()
{
HX_STACK_PUSH("Asin::new","retro/library/math/Asin.hx",17);
{
	HX_STACK_LINE(18)
	this->name = HX_CSTRING("Asin");
	HX_STACK_LINE(19)
...
Dynamic Asin_obj::__CreateEmpty() { return  new Asin_obj; }
hx::ObjectPtr< Asin_obj > Asin_obj::__new()
{  hx::ObjectPtr< Asin_obj > result = new Asin_obj();
	result->__construct();
	return result;}

Dynamic Asin_obj::__Create(hx::DynamicArray inArgs)
{  hx::ObjectPtr< Asin_obj > result = new Asin_obj();
	result->__construct();
	return result;}

hx::Object *Asin_obj::__ToInterface(const hx::type_info &inType) {
	if (inType==typeid( ::retro::core::JobComponent_obj)) return operator ::retro::core::JobComponent_obj *();
	return super::__ToInterface(inType);
}

::String Asin_obj::getModuleName( ){
	HX_STACK_PUSH("Asin::getModuleName","retro/library/math/Asin.hx",36);
	HX_STACK_THIS(this);
	HX_STACK_LINE(36)
	return HX_CSTRING("math.Asin");
}


HX_DEFINE_DYNAMIC_FUNC0(Asin_obj,getModuleName,return )

Void Asin_obj::onInputRecieved( ::retro::core::Params params,Dynamic cb){
{
		HX_STACK_PUSH("Asin::onInputRecieved","retro/library/math/Asin.hx",25);
		HX_STACK_THIS(this);
		...
		HX_STACK_LINE(32)
		result->set(HX_CSTRING("output"),::Math_obj::asin(input->getValue()));
		HX_STACK_LINE(33)
		cb(result).Cast< Void >();
	}
return null();
...
HX_DEFINE_DYNAMIC_FUNC2(Asin_obj,onInputRecieved,(void))
...
void Asin_obj::__Mark(HX_MARK_PARAMS)
{
	HX_MARK_BEGIN_CLASS(Asin);
...
void Asin_obj::__Visit(HX_VISIT_PARAMS)
{
...
Dynamic Asin_obj::__Field(const ::String &inName,bool inCallProp)
{
...
Dynamic Asin_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 4:
...
void Asin_obj::__GetFields(Array< ::String> &outFields)
{
...
static void sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(Asin_obj::__mClass,"__mClass");
};

static void sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(Asin_obj::__mClass,"__mClass");
};

Class Asin_obj::__mClass;

void Asin_obj::__register()
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("retro.library.math.Asin"), hx::TCanCast< Asin_obj> ,sStaticFields,sMemberFields,
	&__CreateEmpty, &__Create,
	&super::__SGetClass(), 0, sMarkStatics, sVisitStatics);
}

void Asin_obj::__boot()
{
}
