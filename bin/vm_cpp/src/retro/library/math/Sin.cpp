...
Void Sin_obj::__construct()
{
HX_STACK_PUSH("Sin::new","retro/library/math/Sin.hx",17);
{
	HX_STACK_LINE(18)
	this->name = HX_CSTRING("Sin");
	HX_STACK_LINE(19)
...
Dynamic Sin_obj::__CreateEmpty() { return  new Sin_obj; }
hx::ObjectPtr< Sin_obj > Sin_obj::__new()
{  hx::ObjectPtr< Sin_obj > result = new Sin_obj();
	result->__construct();
	return result;}

Dynamic Sin_obj::__Create(hx::DynamicArray inArgs)
{  hx::ObjectPtr< Sin_obj > result = new Sin_obj();
	result->__construct();
	return result;}

hx::Object *Sin_obj::__ToInterface(const hx::type_info &inType) {
	if (inType==typeid( ::retro::core::JobComponent_obj)) return operator ::retro::core::JobComponent_obj *();
	return super::__ToInterface(inType);
}

::String Sin_obj::getModuleName( ){
	HX_STACK_PUSH("Sin::getModuleName","retro/library/math/Sin.hx",36);
	HX_STACK_THIS(this);
	HX_STACK_LINE(36)
	return HX_CSTRING("math.Sin");
}


HX_DEFINE_DYNAMIC_FUNC0(Sin_obj,getModuleName,return )

Void Sin_obj::onInputRecieved( ::retro::core::Params params,Dynamic cb){
{
		HX_STACK_PUSH("Sin::onInputRecieved","retro/library/math/Sin.hx",25);
		HX_STACK_THIS(this);
		...
		HX_STACK_LINE(32)
		result->set(HX_CSTRING("output"),::Math_obj::sin(input->getValue()));
		HX_STACK_LINE(33)
		cb(result).Cast< Void >();
	}
return null();
...
HX_DEFINE_DYNAMIC_FUNC2(Sin_obj,onInputRecieved,(void))
...
void Sin_obj::__Mark(HX_MARK_PARAMS)
{
	HX_MARK_BEGIN_CLASS(Sin);
...
void Sin_obj::__Visit(HX_VISIT_PARAMS)
{
...
Dynamic Sin_obj::__Field(const ::String &inName,bool inCallProp)
{
...
Dynamic Sin_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 4:
...
void Sin_obj::__GetFields(Array< ::String> &outFields)
{
...
static void sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(Sin_obj::__mClass,"__mClass");
};

static void sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(Sin_obj::__mClass,"__mClass");
};

Class Sin_obj::__mClass;

void Sin_obj::__register()
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("retro.library.math.Sin"), hx::TCanCast< Sin_obj> ,sStaticFields,sMemberFields,
