...
Void Acos_obj::__construct()
{
HX_STACK_PUSH("Acos::new","retro/library/math/Acos.hx",17);
{
	HX_STACK_LINE(18)
	this->name = HX_CSTRING("Acos");
	HX_STACK_LINE(19)
...
Dynamic Acos_obj::__CreateEmpty() { return  new Acos_obj; }
hx::ObjectPtr< Acos_obj > Acos_obj::__new()
{  hx::ObjectPtr< Acos_obj > result = new Acos_obj();
	result->__construct();
	return result;}

Dynamic Acos_obj::__Create(hx::DynamicArray inArgs)
{  hx::ObjectPtr< Acos_obj > result = new Acos_obj();
	result->__construct();
	return result;}

hx::Object *Acos_obj::__ToInterface(const hx::type_info &inType) {
	if (inType==typeid( ::retro::core::JobComponent_obj)) return operator ::retro::core::JobComponent_obj *();
	return super::__ToInterface(inType);
}

::String Acos_obj::getModuleName( ){
	HX_STACK_PUSH("Acos::getModuleName","retro/library/math/Acos.hx",36);
	HX_STACK_THIS(this);
	HX_STACK_LINE(36)
	return HX_CSTRING("math.Acos");
}


HX_DEFINE_DYNAMIC_FUNC0(Acos_obj,getModuleName,return )

Void Acos_obj::onInputRecieved( ::retro::core::Params params,Dynamic cb){
{
		HX_STACK_PUSH("Acos::onInputRecieved","retro/library/math/Acos.hx",25);
		HX_STACK_THIS(this);
		...
		HX_STACK_LINE(32)
		result->set(HX_CSTRING("output"),::Math_obj::acos(input->getValue()));
		HX_STACK_LINE(33)
		cb(result).Cast< Void >();
	}
return null();
...
HX_DEFINE_DYNAMIC_FUNC2(Acos_obj,onInputRecieved,(void))
...
void Acos_obj::__Mark(HX_MARK_PARAMS)
{
	HX_MARK_BEGIN_CLASS(Acos);
...
void Acos_obj::__Visit(HX_VISIT_PARAMS)
{
...
Dynamic Acos_obj::__Field(const ::String &inName,bool inCallProp)
{
...
Dynamic Acos_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 4:
...
void Acos_obj::__GetFields(Array< ::String> &outFields)
{
...
static void sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(Acos_obj::__mClass,"__mClass");
};

static void sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(Acos_obj::__mClass,"__mClass");
};

Class Acos_obj::__mClass;

void Acos_obj::__register()
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("retro.library.math.Acos"), hx::TCanCast< Acos_obj> ,sStaticFields,sMemberFields,
	&__CreateEmpty, &__Create,
	&super::__SGetClass(), 0, sMarkStatics, sVisitStatics);
}

void Acos_obj::__boot()
{
}
