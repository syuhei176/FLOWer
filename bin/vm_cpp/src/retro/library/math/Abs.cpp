...
Void Abs_obj::__construct()
{
HX_STACK_PUSH("Abs::new","retro/library/math/Abs.hx",17);
{
	HX_STACK_LINE(18)
	this->name = HX_CSTRING("Abs");
	HX_STACK_LINE(19)
...
Dynamic Abs_obj::__CreateEmpty() { return  new Abs_obj; }
hx::ObjectPtr< Abs_obj > Abs_obj::__new()
{  hx::ObjectPtr< Abs_obj > result = new Abs_obj();
	result->__construct();
	return result;}

Dynamic Abs_obj::__Create(hx::DynamicArray inArgs)
{  hx::ObjectPtr< Abs_obj > result = new Abs_obj();
	result->__construct();
	return result;}

hx::Object *Abs_obj::__ToInterface(const hx::type_info &inType) {
	if (inType==typeid( ::retro::core::JobComponent_obj)) return operator ::retro::core::JobComponent_obj *();
	return super::__ToInterface(inType);
}

::String Abs_obj::getModuleName( ){
	HX_STACK_PUSH("Abs::getModuleName","retro/library/math/Abs.hx",36);
	HX_STACK_THIS(this);
	HX_STACK_LINE(36)
	return HX_CSTRING("math.Abs");
}


HX_DEFINE_DYNAMIC_FUNC0(Abs_obj,getModuleName,return )

Void Abs_obj::onInputRecieved( ::retro::core::Params params,Dynamic cb){
{
		HX_STACK_PUSH("Abs::onInputRecieved","retro/library/math/Abs.hx",25);
		HX_STACK_THIS(this);
		...
		HX_STACK_LINE(32)
		result->set(HX_CSTRING("output"),::Math_obj::abs(input->getValue()));
		HX_STACK_LINE(33)
		cb(result).Cast< Void >();
	}
return null();
...
HX_DEFINE_DYNAMIC_FUNC2(Abs_obj,onInputRecieved,(void))
...
void Abs_obj::__Mark(HX_MARK_PARAMS)
{
	HX_MARK_BEGIN_CLASS(Abs);
...
void Abs_obj::__Visit(HX_VISIT_PARAMS)
{
...
Dynamic Abs_obj::__Field(const ::String &inName,bool inCallProp)
{
...
Dynamic Abs_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 4:
...
void Abs_obj::__GetFields(Array< ::String> &outFields)
{
...
static void sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(Abs_obj::__mClass,"__mClass");
};

static void sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(Abs_obj::__mClass,"__mClass");
};

Class Abs_obj::__mClass;

void Abs_obj::__register()
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("retro.library.math.Abs"), hx::TCanCast< Abs_obj> ,sStaticFields,sMemberFields,
