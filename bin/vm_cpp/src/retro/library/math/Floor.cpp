...
{
HX_STACK_PUSH("Floor::new","retro/library/math/Floor.hx",17);
{
	HX_STACK_LINE(18)
	this->name = HX_CSTRING("Floor");
	HX_STACK_LINE(19)
...
{  hx::ObjectPtr< Floor_obj > result = new Floor_obj();
	result->__construct();
	return result;}
...
hx::Object *Floor_obj::__ToInterface(const hx::type_info &inType) {
	if (inType==typeid( ::retro::core::JobComponent_obj)) return operator ::retro::core::JobComponent_obj *();
	return super::__ToInterface(inType);
}

::String Floor_obj::getModuleName( ){
	HX_STACK_PUSH("Floor::getModuleName","retro/library/math/Floor.hx",36);
	HX_STACK_THIS(this);
	HX_STACK_LINE(36)
	return HX_CSTRING("math.Floor");
}


HX_DEFINE_DYNAMIC_FUNC0(Floor_obj,getModuleName,return )

Void Floor_obj::onInputRecieved( ::retro::core::Params params,Dynamic cb){
{
		HX_STACK_PUSH("Floor::onInputRecieved","retro/library/math/Floor.hx",25);
		HX_STACK_THIS(this);
		...
		HX_STACK_LINE(32)
		result->set(HX_CSTRING("output"),::Math_obj::floor(input->getValue()));
		HX_STACK_LINE(33)
		cb(result).Cast< Void >();
	}
return null();
...
HX_DEFINE_DYNAMIC_FUNC2(Floor_obj,onInputRecieved,(void))
...
Dynamic Floor_obj::__Field(const ::String &inName,bool inCallProp)
{
...
Dynamic Floor_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 4:
...
Class Floor_obj::__mClass;

void Floor_obj::__register()
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("retro.library.math.Floor"), hx::TCanCast< Floor_obj> ,sStaticFields,sMemberFields,
	&__CreateEmpty, &__Create,
	&super::__SGetClass(), 0, sMarkStatics, sVisitStatics);
}

void Floor_obj::__boot()
{
}
